...
def train():
    ...
    env = gym.make('peg-in-hole-v0', client=p.DIRECT, task="plug-in", task_num=sub_num, offset = [2.,3.,0.],args=[], is_test=True)
    ...
    # initialize a PointNet2 for feature extraction
    pointnet2 = PointNet2(state_dim, True).to(device)
